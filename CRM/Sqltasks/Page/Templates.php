...
class CRM_Sqltasks_Page_Templates extends CRM_Core_Page {
  ...
  public function run() {
    ...
    CRM_Core_Resources::singleton()->addStyleFile('de.systopia.sqltasks', 'css/templates.css');
    CRM_Core_Resources::singleton()->addScriptFile('de.systopia.sqltasks', 'js/AddBodyClass.js', 1000, 'html-header');
    CRM_Core_Resources::singleton()->addScriptFile('de.systopia.sqltasks', 'js/templates.js', 1000, 'html-header');
